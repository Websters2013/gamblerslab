...
$loadedType = $_GET['loadedType'];
$loadedLink = $_GET['loadedLink'];

if ( $loadedType == "bonus" && $loadedLink == "001" ){
...
} else if ( $loadedType == "bonus" && $loadedLink == "002" ){
...
} else if ( $loadedType == "bonus" && $loadedLink == "005" ){

    echo "
    <div class=\"popup\" data-type=\"bonus\" data-link=\"005\">
...
} else if ( $loadedType == "game" && $loadedLink == "001" ) {
...
} else if ( $loadedType == "comments" && $loadedLink == "001" ) {
...
} else if ( $loadedType == "warning" && $loadedLink == "001" ) {
